...
(function () {
  ...
  function openWhatsAppMessage(thisForm) {
    ...
    if (phone || date || time || people) {
      whatsappText = `Hello Muzneysal Bites & Grill, I would like to book a table. Name: ${name}. Phone: ${phone}. Date: ${date}. Time: ${time}. People: ${people}. Message: ${message}`;
    } else {
